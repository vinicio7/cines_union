...
<body class="body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header__content">
                            <!-- header logo -->
                            <a href="index.html" class="header__logo" style="width: 100px">
                                <img src="https://www.launion.com.gt/wp-content/uploads/2019/01/ICONO-100x100.png" style=" width:60%">
                            </a>
                            <!-- end header logo -->
                            ...
                            <ul class="header__nav">
                                ...
                                <li class="header__nav-item">
                                    <a href="pricing.html" class="header__nav-link">Quienes somos</a>
                                </li>

                                <li class="header__nav-item">
                                    <a href="faq.html" class="header__nav-link">Contacto</a>
                                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header__search-content">
                            <input type="text" placeholder="Busca una pelicula por nombre">
    ...
    <section class="home">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="home__title"><b>Proximos Estrenos </h1>
